...
export default function VocabularyCard({ title, subtitle, imageUrl, itemsCount, coursePath, ...props }) {
    return (
        <Card
        ...
        >
            ...
            <Card.Content>
                ...
                <Card.Text level="body-sm">Количество слов - {itemsCount}</Card.Text>
